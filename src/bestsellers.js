          ...
          <div className="card-contents">
            ...
            <ul className="card-list">
              ...
              <li>
                ...
                <span>Comfortable for 2 Days</span>
              </li>
              <li>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="card-contents">
            ...
            <ul className="card-list">
              ...
              <li>
                ...
                <span>Approx 0.095 Tonnage</span>
              </li>
            </ul>
          ...
          <div className="card-contents">
            ...
            <ul className="card-list">
              ...
              <li>
                ...
                <span>Comfortable for 1-2 Mins.</span>
              </li>
              <li>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
