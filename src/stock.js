      ...
      <section className="section-current-stock" id="current-stock">
        <div className="carousel-window" ref={scrollRef}>
            ...
            <div className="stock-card-contents">
              ...
              <ul className="stock-card-list">
                ...
                <li>
                  ...
                  <span>Approx 0.0249 Tonnage</span>
                </li>
              </ul>
          ...
          <div className="stock-card">
            ...
            <div className="stock-card-contents">
              <h4 className="stock-card-title">The Secret Gardener </h4>
              <ul className="stock-card-list">
                <li>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="stock-card-contents">
              ...
              <ul className="stock-card-list">
                ...
                <li>
                  ...
                  <span>Wet Notebooks & Metal Bars</span>
                </li>
                <li>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="stock-card">
            ...
            <div className="stock-card-contents">
              <h4 className="stock-card-title">The Postman's Folly</h4>
              <ul className="stock-card-list">
                <li>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <li>
                  ...
                  <span>Comfortable for 1 Day</span>
                </li>
                <li>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span>Quilted Italian Cambric</span>
                </li>
                <li>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="stock-card">
            ...
            <div className="stock-card-contents">
              <h4 className="stock-card-title">The Shock Rider</h4>
              <ul className="stock-card-list">
                <li>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span>Limited Edition Bike Seat</span>
                </li>
                <li>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span>Comfortable for All Bikes</span>
                </li>
                <li>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span>Pristine Marred Texture</span>
                </li>
                <li>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="stock-card">
            ...
            <div className="stock-card-contents">
              <h4 className="stock-card-title">The Vertigo Cure</h4>
              <ul className="stock-card-list">
                <li>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="stock-card-contents">
              ...
              <ul className="stock-card-list">
                <li>
                  ...
                  <span>Phone Calls & People Watching</span>
                </li>
                <li>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span>Comfortable for 2-3 Hours</span>
                </li>
                <li>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span>Hollow Steel Pipe Frame</span>
                </li>
                <li>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="stock-card">
            ...
            <div className="stock-card-contents">
              <h4 className="stock-card-title">The Big Cheese</h4>
              <ul className="stock-card-list">
                <li>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span>Melancholia & Sunbathing</span>
                </li>
                <li>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <li>
                  ...
                  <span>Delicate Shalloon Covering</span>
                </li>
                <li>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span>Approx 0.0275 Tonnage</span>
                </li>
              </ul>
