      ...
      <section className="section-current-stock" id="current-stock">
        ...
        <div className="carousel-window" ref={scrollRef}>
          ...
          <div className="stock-card">
            ...
            <div className="stock-card-contents">
              <h4 className="stock-card-title">The Blank Blank</h4>
              <ul className="stock-card-list">
                <li>
          ...
          <div className="stock-card">
            ...
            <div className="stock-card-contents">
              ...
              <ul className="stock-card-list">
                <li>
                  <span>Leaning & People Watching</span>
                </li>
                <li>
                  <span>Comfortable for 2-3 Hours</span>
                </li>
                <li>
                  <span>Steel Pipe Frame</span>
                </li>
                <li>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
