      ...
      <section className="section-our-chairs" id="our-chairs ">
        <div className="our-chairs-fact">
          <h3 className="our-chairs-subheadline">
            <i className="ph ph-arrow-bend-down-right"></i> Ethical and
            sustainable
          </h3>
          <p className="our-chairs-text">
        ...
        <div className="our-chairs-fact">
          <h3 className="our-chairs-subheadline">
            <i className="ph ph-arrow-bend-down-right"></i> Science meets design
          </h3>
          <p className="our-chairs-text">
        ...
        <div className="our-chairs-fact">
          <h3 className="our-chairs-subheadline">
            <i className="ph ph-arrow-bend-down-right"></i> Guaranteed warranty
            contract deal
          </h3>
          <p className="our-chairs-text">
            Our chairs come with an official legal document guaranteeing that it
            is true and has the right to remain silent. Your rights are valid
            upon notary, and will be available for download within 36 hours of
            completed purchase. No other chair manufacturer can beat our
